...
(()=>{
    ...
    document.addEventListener("click" , (event)=>{
        ...
        if( event.target.classList.contains("link-item")){
            // make sure event.target .Hash has a value before overriding default behaiviour
            if(event.target.hash !==""){
                // prevent default anchor click behavior
                event.preventDefault();
                const hash =event.target.hash;
                // deactivated existing active section
console.log(hash);
                ...
                navMenu.querySelector(".active").classList.remove("outer-shadow","hover-in-shadow");


               //if clicked "link item is contained withing the nevigation menu"
                if(navMenu.classList.contains("open")){
                    ...
                    console.log("yes");
                      ...
                      navItems.forEach((item)=>{
                          if(hash === item.hash){
                              //active ne navigation "link item"
...
''
     ...
     function popupSlideShow(){
         ...
         popupImg.src=imgSrc;
         popupImg.onload = ()=>{
            //  deactivate loader after the popup img load
    ...
    function popupDetails(){
        ...
        // if portfolioItems not exists
        if(!portfolioItems[itemIndex].querySelector(".portfolio-item-details")){
            projectDetailsBtn.style.display="none";
            return; /*end funtion execution */
        }
        ...
        popup.querySelector(".pp-project-catagory").innerHTML = catagory.split("-").join(" ");
...
(()=>{
    ...
    function slider(){
        ...
        // deactived existing active slides
